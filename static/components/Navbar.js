...
const Navbar = {
    ...
    <router-link v-if="state.loggedIn && state.role === 'student' " to="/dashboard-stud">Dashboard</router-link>
    <router-link v-if="state.loggedIn && state.role === 'instructor' " to="/dashboard-inst">Dashboard</router-link>
